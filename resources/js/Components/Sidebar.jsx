...
import { SidebarHeader, SidebarLayout } from "./Partials/SidebarLayout";
...
export default function Sidebar({ className, isCollapsed, setIsCollapsed }) {
    ...
    return (
        ...
        >
            ...
            <SidebarLayout>
                <SidebarHeader className="sticky top-0 justify-between px-4 py-3 shadow md:px-4">
                    <div
                        className={`flex items-center text-slate-950 dark:text-slate-100 ${
                            !isCollapsed ? "gap-2" : ""
                        }`}
                    >
                        <svg
                ...
                {/* Width navigation toggle button */}
                <Button
